...
- [SocialSdk 登录分享功能原生接入](https://github.com/chendongMarch/SocialSdkLibrary)
- [LightAdapter 轻量级适配器](https://github.com/chendongMarch/LightAdapter)
- [ImageEditor 图片处理，裁剪旋转，贴纸涂鸦，滤镜等](https://github.com/chendongMarch/ImageEditor)
- [WeexCube Weex 容器方案](https://github.com/chendongMarch/Weex-Cube)
- [Kotlin 学习系列总结,共计 22 篇](http://cdevlab.top/article/bbab636a/)        